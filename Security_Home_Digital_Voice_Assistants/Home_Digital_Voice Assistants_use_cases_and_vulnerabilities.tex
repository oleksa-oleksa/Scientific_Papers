...
\begin{figure}[thpb]
	\centering
	\includegraphics[scale=0.35]{img/skills.png}
...
\subsection{About}
	\textbf{VPA on IoT devices}.  	

These assistants have a range of capabilities, from weather report, timer setting, to-do list maintenance to voice shopping, hands-free messaging and calling. The user can manage these capabilities through a companion app running on her smartphone.
