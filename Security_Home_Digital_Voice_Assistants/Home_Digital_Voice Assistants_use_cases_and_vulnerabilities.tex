...
Users also asked about the temperature on that particular time as well as future forecasts, attimes asking for a specific day, for example, ?Alexa, is it gonna snow two days from now?? \cite{c6}
